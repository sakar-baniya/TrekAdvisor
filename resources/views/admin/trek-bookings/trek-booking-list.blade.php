...
<x-layouts.dashboard>
    ...
    <section class="bg-white p-5 md:p-6 rounded-xl border border-slate-200 shadow-sm mb-8">
        <form method="GET" action="{{ route('admin.trek-bookings.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-center gap-4 border-t md:border-t-0 pt-4 md:pt-0">
                        @php
                            ...
                            $badgeStyle = match($statusVal) {
                                ...
                                'cancelled', 'cancel requested' => 'bg-red-50 text-red-700 border-red-100',
                        ...
                        <a href="{{ route('admin.trek-bookings.show', $booking) }}" class="inline-flex items-center px-4 py-2 border border-slate-200 text-slate-700 text-sm font-medium rounded-lg hover:bg-slate-50 transition-colors">
                            Details
                        </a>
                    </div>
                </div>
