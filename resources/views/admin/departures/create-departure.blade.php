<x-dashboard-layout>
    <div class="max-w-4xl mx-auto">
        <!-- Page Header -->
        <div class="mb-10">
            <a href="{{ route('admin.departures.index') }}" class="inline-flex items-center text-[10px] font-semibold uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors mb-4">
