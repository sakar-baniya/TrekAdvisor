    ...
    <x-slot name="header">
        <div class="admin-page-heading admin-page-heading--split">
            <div>
                ...
                <h2 class="admin-page-title">{{ $payment->transaction_id }}</h2>
            </div>
            <a href="{{ route('admin.payments.index') }}" class="admin-secondary-button">
        ...
        <article class="admin-panel">
            <div class="admin-panel__header">
                <div>
                    ...
                    <p>Main transaction and booking reference details</p>
                </div>
            </div>
            ...
            <section class="admin-panel">
                <div class="admin-panel__header">
                    <div>
                        ...
                        <p>Stored raw response payload</p>
                    </div>
                </div>
