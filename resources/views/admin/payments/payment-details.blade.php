...
@section('page-back', route('admin.payments.index'))
                    ...
                    @if ($reference)
                        ...
                        @if ($payment->payable_type === 'trek')
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('admin.trek-bookings.show', $reference) }}" class="inline-flex text-xs font-medium text-blue-600 hover:text-blue-800">
                        ...
                        @elseif ($payment->payable_type === 'hotel')
                            <div class="space-y-1">
                                ...
                                <span class="text-xs font-medium text-slate-500 bg-slate-50 px-2 py-0.5 rounded-lg border border-slate-100">
