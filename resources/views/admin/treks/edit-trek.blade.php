        ...
        <form action="{{ route('admin.treks.update', $trek) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                    ...
                    <h1 class="text-4xl font-black text-slate-900 tracking-tight">Edit Trek</h1>
                ...
                <div class="flex items-center gap-3 bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <div>
                        <span class="block text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Status</span>
                        <strong class="text-xs font-black text-slate-900 uppercase">{{ $trek->status }}</strong>
                    </div>
                </div>
            </div>
