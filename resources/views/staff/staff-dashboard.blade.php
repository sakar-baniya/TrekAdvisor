<x-layouts.dashboard>
        ...
        @foreach([
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow flex items-center gap-5">
                ...
                <div>
                    ...
                    <span class="block text-[10px] font-semibold text-slate-400 uppercase tracking-widest">{{ $stat['label'] }}</span>
                </div>
            </div>
        @endforeach
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            <div>
                <h3 class="text-lg font-semibold text-slate-900 tracking-tight">Booking Activity</h3>
                <p class="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mt-1 mb-8">Daily Volume (Last 7 Days)</p>
            </div>
            <div class="h-[300px]">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm flex flex-col overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/20">
                <h3 class="text-sm font-semibold text-slate-900 uppercase tracking-widest">Recent Orders</h3>
            </div>
                            ...
                            <tr class="group hover:bg-slate-50/50 transition-colors">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-3 mb-1">
                                         <span class="text-[9px] font-semibold text-slate-400 uppercase tracking-tighter">#{{ $booking->booking_reference }}</span>
                                         @php
                                    ...
                                    <div class="text-sm font-semibold text-slate-900 group-hover:text-emerald-600 transition-colors line-clamp-1">
            ...
            <div class="p-6 bg-slate-50/50 border-t border-slate-50">
                <a href="{{ route('staff.trek-bookings.index') }}" class="inline-flex justify-center items-center w-full py-3 bg-white border border-slate-200 text-slate-600 text-[10px] font-semibold rounded-xl hover:bg-slate-900 hover:text-white transition-all uppercase tracking-widest shadow-sm">
                    All Bookings &rarr;
                </a>
            </div>
        </div>
