<x-dashboard-layout>
    ...
    <section class="admin-panel">
        ...
        <form method="GET" action="{{ route('staff.trek-bookings.index') }}" class="admin-filter-grid">
                ...
                <tbody>
                    @forelse ($bookings as $booking)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('staff.trek-bookings.show', $booking) }}" class="admin-secondary-button">
