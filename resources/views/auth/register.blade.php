    ...
    <form method="POST" action="{{ route('register') }}" class="auth-form">
        ...
        <div class="auth-grid auth-grid--two" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
            <div class="auth-field" style="margin-bottom: 0;">
                ...
                <x-text-input id="name" class="auth-input" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="eg: Suman Shrestha" />
                <x-input-error :messages="$errors->get('name')" />
            </div>

            <div class="auth-field" style="margin-bottom: 0;">
                <x-input-label for="phone" :value="__('Phone (optional)')" />
                <x-text-input id="phone" class="auth-input" type="text" name="phone" :value="old('phone')" autocomplete="tel" placeholder="eg: +977 98000..." />
        ...
        <div class="auth-field" style="margin-bottom: 24px;">
            ...
            <x-text-input id="email" class="auth-input" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="eg: suman.nepal@gmail.com" />
