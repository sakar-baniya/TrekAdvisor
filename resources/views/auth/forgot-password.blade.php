<x-auth-page 
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
        ...
        <button type="submit" class="w-full py-4 bg-slate-900 text-white rounded-xl font-black uppercase tracking-[0.2em] text-xs hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20 active:scale-[0.98] flex items-center justify-center gap-2">
            Send Reset Link
