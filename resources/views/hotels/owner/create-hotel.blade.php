    ...
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('hotel_owner.hotels.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                    <a href="{{ route('hotel_owner.hotels.index') }}" class="inline-flex items-center text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors mb-4">
                        <i class="fas fa-arrow-left mr-2"></i> My Properties
                    </a>
                    <h1 class="text-4xl font-black text-slate-900 tracking-tight">Register Hotel</h1>
                    <p class="text-slate-500 font-medium mt-1 uppercase tracking-widest text-xs italic italic">Add your property to the TrekAdvisor marketplace</p>
                </div>
            </div>
                ...
                <div class="max-w-7xl mx-auto flex items-center justify-between">
                    <div class="hidden md:flex items-center gap-3">
                        ...
                        <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">
                            Draft Status:<br><span class="text-slate-900">Pending Review</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 w-full md:w-auto">
                        <a href="{{ route('hotel_owner.hotels.index') }}" class="flex-1 md:flex-none text-center px-8 py-3 bg-slate-50 text-slate-600 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-100 transition-all">
                            Cancel
                        </a>
