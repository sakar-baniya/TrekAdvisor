...
<div class="space-y-12">
    ...
    <section class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden text-black">
        ...
        <div class="p-8 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="space-y-2">
                <x-input-label value="Hotel Name *" class="text-[10px] font-semibold uppercase tracking-widest text-slate-400" />
            ...
            <div class="space-y-2">
                <x-input-label value="Location *" class="text-[10px] font-semibold uppercase tracking-widest text-slate-400" />
