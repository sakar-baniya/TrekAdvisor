<x-dashboard-layout>
    <x-slot name="header">
        <div class="admin-page-heading">
            <div>
                ...
                <p class="admin-eyebrow">Bookings for your properties</p>
            </div>
        </div>
    </x-slot>
    ...
    <section class="admin-panel">
        <div class="admin-panel__header">
            <div>
                <h3>Filters</h3>
                <p>Search customer/reference and filter by hotel/status</p>
            </div>
        </div>

        <form method="GET" action="{{ route('hotel_owner.bookings.index') }}" class="admin-filter-grid">
    ...
    <section class="admin-panel">
        <div class="admin-panel__header">
            <div>
                <h3>Bookings</h3>
                <p>Latest booking requests and stay updates</p>
            </div>
        </div>
                ...
                <tbody>
                    @forelse ($bookings as $booking)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('hotel_owner.bookings.show', $booking) }}" class="admin-secondary-button">
                                    <span>View</span>
                                </a>
                            </td>
                        </tr>
