        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-12 relative">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-black shadow-lg shadow-slate-900/10">
                        <i class="fas fa-check text-xs"></i>
                    </div>
                    <span class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Info</span>
                </div>
                <div class="relative z-10 flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-black shadow-lg shadow-slate-900/20">2</div>
                    <span class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-900">Passengers</span>
                </div>
                <div class="relative z-10 flex flex-col items-center">
                ...
                <div class="p-8 md:p-12">
                    <form action="{{ route('bookings.confirm') }}" method="POST" class="max-w-3xl mx-auto space-y-12">
                        ...
                        <div class="text-center">
                            <h1 class="text-3xl font-black text-slate-900 tracking-tight mb-3">Passenger Details</h1>
                            ...
                            @for($i = 0; $i < $bookingData['total_passengers']; $i++)
                                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                                     <div class="bg-slate-900 px-8 py-3 flex items-center justify-between">
                                         <h3 class="text-xs font-black text-white uppercase tracking-widest">Passenger #{{ $i + 1 }}</h3>
                        ...
                        <div class="p-8 bg-slate-50 rounded-3xl border border-slate-100">
                             <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest mb-6 px-1">Choose Payment Method</h4>
                             <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                 ...
                                 <label class="relative flex items-center gap-4 p-5 bg-white rounded-2xl border-2 border-slate-100 cursor-pointer hover:border-slate-900 transition-all group">
                                     ...
                                     <div class="flex items-center gap-3">
                                         <div class="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-lg font-black italic">
                                             e
                                         </div>
                                         <div>
