        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-12 relative">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-black shadow-lg shadow-slate-900/20">1</div>
                    <span class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-900">Info</span>
                </div>
                <div class="relative z-10 flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full bg-white border-2 border-slate-200 text-slate-400 flex items-center justify-center font-black">2</div>
                    <span class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Passengers</span>
                </div>
                <div class="relative z-10 flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full bg-white border-2 border-slate-200 text-slate-400 flex items-center justify-center font-black">3</div>
                    <span class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Confirm</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-900/5 border border-slate-100 overflow-hidden" 
                ...
                <div class="relative h-64 md:h-80">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
                        <p class="text-emerald-400 font-black uppercase tracking-widest text-xs mb-2">Step 1: Configuration</p>
                        <h1 class="text-3xl md:text-4xl font-black text-white tracking-tight mb-2">{{ $departure->trek->title }}</h1>
                ...
                <div class="p-8 md:p-12">
                    <form action="{{ route('bookings.store') }}" method="POST" class="max-w-xl mx-auto">
                        ...
                        <div class="text-center mb-10">
                            <h2 class="text-2xl font-black text-slate-900 tracking-tight mb-3">How many people are traveling?</h2>
                        ...
                        <div class="flex items-center justify-center gap-8 mb-12">
                            <button type="button" @click="if(count > 1) count--" class="w-16 h-16 rounded-2xl bg-slate-100 text-slate-600 text-2xl font-black hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                                -
                            </button>
                            <div class="text-center">
                                <span class="text-6xl font-black text-slate-900 tracking-tighter" x-text="count"></span>
                                <span class="block text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Passengers</span>
                            </div>
                            <button type="button" @click="if(count < max) count++" class="w-16 h-16 rounded-2xl bg-slate-100 text-slate-600 text-2xl font-black hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                                +
                            </button>
                        </div>
                        ...
                        <div class="flex items-center justify-center gap-2 mb-12">
                            <span class="px-4 py-1.5 rounded-full bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest shadow-xl">
                        ...
                        <div class="bg-slate-50 rounded-3xl p-8 space-y-4 border border-slate-100 mb-10 shadow-inner">
                            ...
                            <div class="flex justify-between items-center text-sm font-bold text-slate-400 uppercase tracking-widest">
                                ...
                                <span class="text-emerald-600" x-text="discount + '%'"></span>
                            </div>
                            <div class="pt-6 border-t border-slate-200 flex justify-between items-center">
                                <div class="flex flex-col">
                                    <span class="text-xs font-black text-slate-400 uppercase tracking-widest">Estimated Total</span>
                                    <span class="text-[10px] font-bold text-slate-400">(Auto-calculated)</span>
                                </div>
                                <strong class="text-3xl font-black text-slate-900 tracking-tight" x-text="'NPR ' + format(total)"></strong>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="w-full py-5 bg-slate-900 text-white font-black rounded-2xl shadow-2xl shadow-slate-900/20 hover:bg-slate-800 transition-all uppercase tracking-widest text-sm flex items-center justify-center gap-3 group">
