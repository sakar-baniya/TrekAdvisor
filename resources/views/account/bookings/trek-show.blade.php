        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                document.querySelectorAll('[data-passenger-section]').forEach(function (section) {
                    var panel = section.closest('.account-panel');
                    ...
                    if (!viewPane || !editPane || !openButton) {
                        return;
                    }

                    var setEditMode = function (isEditing) {
                        viewPane.classList.toggle('account-is-hidden', isEditing);
                        editPane.classList.toggle('account-is-hidden', !isEditing);
                        openButton.setAttribute('aria-expanded', isEditing ? 'true' : 'false');
                    };
