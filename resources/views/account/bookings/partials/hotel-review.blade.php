    ...
    <section class="account-panel">
        <div class="account-panel__head">
            <div>
                ...
                <p>Share your stay experience with other travelers.</p>
            </div>
        </div>
        ...
        @else
            @if ($booking->hotelRoom?->hotel)
                <x-reviews.form :action="route('account.reviews.hotels.store', $booking->hotelRoom->hotel)" submit-label="Submit Review" />
            @endif
        @endif
    </section>
@else
